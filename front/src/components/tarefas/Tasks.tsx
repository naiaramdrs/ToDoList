            ...
            <div className="check-list">
                <ul className="list">
                    <li id={item.concluida ? "marcado" : "nada"}>
                        ...
                        <div>
                            <button className="remove" onClick={() => deleteTask(item.id)}><IonIcon icon={trash} color='dark'></IonIcon></button>
                            <button className='pincel' onClick={() => editTask(item)}><IonIcon icon={create} color='dark'></IonIcon></button>
                        </div>
